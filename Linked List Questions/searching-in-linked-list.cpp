...
bool search(node *head,int search_ele)
{
    node *temp = head;
    while(temp!=NULL)
    {
...
int main()
{
    ...
    insertathead(head,4);
    print(head);
    cout<<"-----lets check whether a number is present in the linked list or not.if present it'll give 1 and 0 for not in list-----\n";
    cout<<"lets check for element 5 in the linked list-\n";
    cout<<search(head,5)<<endl;
    cout<<"let's search for element 2-\n";
